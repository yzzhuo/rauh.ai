...
export default function Home() {
  ...
  return (
    <main className="flex h-screen overflow-hidden flex-col items-center justify-center p-24">
      ...
      <div className="mb-32 mt-24 flex text-center justify-center lg:mb-0 lg:w-full lg:max-w-5xl ">
        <Button className="cursor-pointer" size="4" onClick={handleClickStart}>Start Practice</Button>
      </div>
    </main>
  );
}
